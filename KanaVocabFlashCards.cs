        ...
        private readonly string[][] KanaWordsRomaji = new string[][] {
            ...
            // にゃ行 (Nya-row) - Contribution by Object777
            new string[] { "nyanko", "gunyagunya", "konnyaku", "nyaanyaa", "rounyakunannyo", "funyafunya" },
            ...
            // じゃ行 (Ja-row) - Contribution by Soup/Yuka ゆか
            new string[] { "jaa", "jama", "jaa mata", "ja nai", "janken", "janjan" },
            ...
            // Katakana
            // ア行 (A-row) - Contribution by Object777
            new string[] { "amerika", "anime", "akusesu", "adoresu", "aisukuriimu", "apaato" },
            new string[] { "intaanetto", "ibento", "imeeji", "indo", "itarian", "ikemen" },
            new string[] { "uuru", "uirusu", "uuman", "uesuto", "uisukii", "uinku" },
            new string[] { "eakon", "enerugii", "eko", "eriito", "eraa", "ekuseru" },
            new string[] { "oupun", "orenji", "oiru", "onrain", "oubun", "ousutoraria" },
            // カ行 (Ka-row) - Contribution by Object777
            new string[] { "kaado", "karaa", "karorii", "kafe", "karee", "kaanabi" },
            new string[] { "kicchin", "kiiboudo", "kisu", "kizzu", "kirisuto", "kiiwaado" },
            new string[] { "kurabu", "kuuraa", "kukkii", "kuuru", "kureemu", "kurisumasu" },
            new string[] { "keetai", "keeki", "keesu", "kechappu", "maaketto", "sukeeto" },
            new string[] { "kouhii", "kosuto", "komikku", "konbini", "koppu", "komyunitii" },
            // サ行 (Sa-row) - Contribution by Object777
            new string[] { "saabisu", "sarada", "saito", "sandoicchi", "sakkaa", "sangurasu" },
            new string[] { "shisutemu", "shinpuru", "shiito", "shiriizu", "shiizun", "shinguru" },
            new string[] { "supoutsu", "sutairu", "sutoppu", "sutaato", "sutoroberii", "supaisu" },
            new string[] { "sentaa", "seerusu", "sensu", "seetaa", "seminaa", "serebu" },
            new string[] { "sousu", "sofuto", "songu", "sokkusu", "souru", "sofaa" },
            // タ行 (Ta-row) - Contribution by Object777
            new string[] { "takushii", "taimu", "taoru", "tai", "tawaa", "taimingu" },
            new string[] { "chikin", "chiizu", "chiimu", "chiketto", "chippusu", "chiri" },
            new string[] { "tsuaa", "tsurii", "tsuna", "tsuuru", "shiitsu", "swiitsu" },
            new string[] { "terebi", "teeburu", "tenisu", "tesuto", "teema", "tero" },
            new string[] { "tousuto", "tomato", "toppu", "torendo", "toutaru", "toreeningu" },
            // ナ行 (Na-row) - Contribution by Object777
            new string[] { "nanbaa", "naisu", "naito", "naifu", "napukin", "nabigeeshon" },
            new string[] { "niizu", "nitto", "niito", "monitaa", "suniikaa", "banira" },
            new string[] { "nuudoru", "nuudo", "kanuu", "seenu", "sezannu", "sorubonnu" },
            new string[] { "netto", "neemu", "nekutai", "nekku", "negatibu", "nekkuresu" },
            new string[] { "nouto", "nonshugaa", "noutopasokon", "non-sutoppu", "noruwee", "non-arukouru" },
            // ハ行 (Ha-row) - Contribution by Object777
            new string[] { "haiteku", "harou waaku", "haato", "hankachi", "hawai", "haabaado" },
            new string[] { "hitto", "hiito", "hinto", "hiiru", "hiirou", "himaraya" },
            new string[] { "furuutsu", "furiitaa", "furaido poteto", "furansu", "furasshu", "fuudo" },
            new string[] { "herushi", "hea", "heasutairu", "herupu", "herikoputaa", "herumetto" },
            new string[] { "houmupeeji", "hoteru", "hotto", "houru", "horidee", "honkon" },
            // マ行 (Ma-row) - Contribution by Object777
            new string[] { "manshon", "mayoneeze", "masukomi", "manaa", "mantsuuman", "maaketingu" },
            new string[] { "misu", "mikkusu", "miitingu", "miruku", "mini", "miitobouru" },
            new string[] { "geemu", "muubii", "muudo", "hamu", "doumu", "muusu" },
            new string[] { "meeru", "menyuu", "menbaa", "memori kaado", "memo", "menzu" },
            new string[] { "moderu", "mouru", "modan", "monoreeru", "monsutaa", "mongoru" },
            // ヤ行 (Ya-row) - Contribution by Object777
            new string[] { "yangu", "yankii", "iyaringu", "daiya", "taiya", "haiyaa" },
            new string[] { "yuuzaa", "yuniinu", "yuumoa", "yuuro", "yudaya", "yuugosurabia" },
            new string[] { "youroppa", "youguruto", "yotto", "youyou", "yorudan", "kureyon" },
            // ラ行 (Ra-row) - Contribution by Object777
            new string[] { "ranchi", "raamen", "rabu", "raito", "rankingu", "raibu" },
            new string[] { "risaikuru", "risutora", "riido", "ribingu", "rizouto", "riigu" },
            new string[] { "ruuru", "rupo", "ruutsu", "ruuto", "sukuuru", "biiru" },
            new string[] { "resutoran", "reshiito", "ressun", "reshipi", "retasu", "reezaa" },
            new string[] { "roguin", "rokkaa", "robotto", "roun", "rondon", "roshia" },
            // ワ行 (Wa-row) - Contribution by Object777
            new string[] { "wain", "waarudo", "waishatsu", "wakuchin", "wansegu", "waado" },
            new string[] { "", "", "", "", "", "" },
            new string[] { "kan", "rimokon", "hanbaagaa", "besuto ten", "kontorouru", "konpyuutaa" },
            // 濁音 (Dakuon - Voiced sounds)
            // ガ行 (Ga-row) - Contribution by Object777
            new string[] { "gaido", "gasu", "gasorin", "garasu", "gaadeningu", "gareeji" },
            new string[] { "gifuto", "gitaa", "girisha", "gia", "ginesubukku", "ideorogii" },
            new string[] { "gurume", "guriin", "guzzu", "guamu", "gurando", "mazaaguusu" },
            new string[] { "geemu", "gesuto", "geesen", "geeto", "gei", "koraagen" },
            new string[] { "gouru", "gomu", "gojira", "gouruden wiku", "gouya", "shikago" },
            // ザ行 (Za-row) - Contribution by Object777
            new string[] { "piza", "rezaa", "erizabesu", "gaza", "reezaa", "mazaa" },
            new string[] { "jiinzu", "jimu", "jin", "dejitaru", "myuujikku", "chinpanjii" },
            new string[] { "zubon", "zuumu", "pazuru", "rouzu", "zukkiini", "shuuzu" },
            ...
            new string[] { "", "", "", "", "", "" },
            new string[] { "", "", "", "", "", "" },
            new string[] { "deeta", "depaato", "dezain", "deeto", "dezaato", "dejikame" },
            new string[] { "doa", "dorama", "doresshingu", "doraggu sutoa", "dottokomu", "haado" },
            // バ行 (Ba-row) - Contribution by Object777
            new string[] { "basu", "baggu", "baa", "banana", "baiku", "baasudee" },
            new string[] { "biniiru", "bijinesu", "bitamin", "bideo", "biru", "biza" },
            new string[] { "burando", "buumu", "burokkori", "buruuberii", "burajaa", "buranko" },
            new string[] { "besuto", "beddo", "beruto", "beranda", "beteran", "bebiikaa" },
            new string[] { "bouru", "botoru", "boutu", "bosu", "borantia", "botan" },
            // パ行 (Pa-row) - Contribution by Object777
            new string[] { "pan", "pasokon", "pasupouto", "paato", "pawaapointo", "pari" },
            new string[] { "pinto", "piano", "pinku", "piasu", "piiman", "pittyaa" },
            new string[] { "purezento", "puro", "puroguramu", "purintaa", "purofiiru", "puraibeeto" },
            new string[] { "petto", "pen", "peeji", "penki", "peruu", "peppaa" },
            new string[] { "pointo", "posuto", "posutaa", "pokketo", "potto", "poppu" },
            // 拗音 (Youon - Contracted sounds)
            // キャ行 (Kya-row) - Contribution by Object777
            new string[] { "kyaria", "kyabetsu", "kyarakutaa", "kyasshingu", "kyaputen", "kyacchaa" },
            new string[] { "baabekyuu", "sekyuritii", "kyuuba", "kyuuto", "sankyuu", "resukyuu" },
            new string[] { "", "", "", "", "", "" },
            // シャ行 (Sha-row) - Contribution by Object777
            new string[] { "shatsu", "shanpuu", "shawaa", "shanpan", "shai", "myuujishan" },
            new string[] { "shugaa", "shuukuriimu", "shuuto", "pusshu", "shuumai", "masshuruumu" },
            new string[] { "shefu", "sheeku", "shea", "sheebaa", "sheekusupia", "sherii" },
            new string[] { "shoppu", "shou", "shoppingu", "shokku", "shorudaabaggu", "kusshon" },
            // チャ行 (Cha-row) - Contribution by Object777
            new string[] { "channeru", "chansu", "chanpion", "chaperu", "chairudo", "chaamingu" },
            new string[] { "chuurippu", "chuuingamu", "chuunaa", "chuubu", "shichuu", "suchuudento" },
            new string[] { "chekku-in", "cheen", "cherii", "chenji", "chesu", "chekku" },
            new string[] { "chokoreeto", "choisu", "chouku", "kuesuchon", "choppu", "ranchon-matto" },
            // ニャ行 (Nya-row) - Contribution by Object777
            new string[] { "konyakku", "nyanko", "konnyaku", "kataruunya", "borounya", "baanya-kauda" },
            new string[] { "nyuusu", "nyuuyouku", "nyuu", "nyuutaun", "nyuujiirando", "nyuansu" },
            new string[] { "eruniinyo", "nyokki", "shanpinyon", "harapeenyo", "abinyon", "nyokumamu" },
            ...
            new string[] { "kasutiirya", "kouryan", "paeerya", "", "", "" },
            ...
            new string[] { "gyaru", "gyanburu", "gyagu", "gyangu", "gyararii", "gyara" },
            new string[] { "regyuraa", "figyua", "figyua-skeeto", "iregyuraa", "regyureeta", "" },
            new string[] { "gyouza", "", "", "", "", "" },
            // ジャ行 (Ja-row) - Contribution by Object777
            new string[] { "jamu", "jaketto", "jazu", "janru", "jaanaru", "janpu" },
            new string[] { "junia", "juusu", "juerii", "juneebu", "koraaju", "ruuju" },
            new string[] { "jetto", "jerii", "jerashii", "jesuchaa", "obuje", "jeemusu" },
            new string[] { "jouku", "jogingu", "jokki", "", "", "" },
            // ビャ行 (Bya-row) - Contribution by Object777
            new string[] { "", "", "", "", "", "" },
            new string[] { "byuutii", "intabyuu", "byuffe", "byuuraa", "rebyuu", "debyuu" },
            new string[] { "", "", "", "", "", "" },
            // ピャ行 (Pya-row) - Contribution by Object777
            new string[] { "", "", "", "", "", "" },
            new string[] { "popyuraa", "pyua", "pyuuma", "pyurittsaa", "pyuure", "" },
            new string[] { "pyonyan", "pyoutoru", "", "", "", "" },
            // 外来音 (Gairaigo - Loan/foreign sounds)
            // ティ・トゥ行 (Ti/Tu-row) - Contribution by Object777
            new string[] { "tii", "paatii", "tisshu", "taidentitii", "patishie", "baraetii" },
            new string[] { "tuuba", "insutituuto", "tuishon", "", "", "" },
            // ディ・ドゥ行 (Di/Du-row) - Contribution by Object777
            new string[] { "dinaa", "diipu", "merodii", "parodii", "direkutaa", "disuku" },
            new string[] { "duaru", "edukeeshon", "fondu", "duetto", "puroduusaa", "duo" },
            // ファ行 (Fa-row) - Contribution by Object777
            new string[] { "famirii", "fasshon", "fakkusu", "faito", "", "" },
            new string[] { "fisshu", "firumu", "fiito", "fikushon", "", "" },
            new string[] { "manifesuto", "feminin", "fensu", "fea puree", "", "" },
            ...
            new string[] { "wiiku", "windou", "wiggu", "winnaa", "sandowicchi", "harowiin" },
            new string[] { "werukamu", "kuweeto", "wedingu", "wenzudee", "", "" },
            new string[] { "woukingu", "wourusutoriito", "woumuappu", "woutaa", "", "" },
            // ヴァ行 (Va-row) - Contribution by Object777
            new string[] { "vaiorin", "varieeshon", "vaajin", "vaioretto", "vivarudi", "vakeeshon" },
            new string[] { "", "", "", "", "", "" },
            new string[] { "", "", "", "", "", "" },
            new string[] { "", "", "", "", "", "" },
            new string[] { "", "", "", "", "", "" },
